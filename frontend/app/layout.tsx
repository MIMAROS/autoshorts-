...
export const metadata: Metadata = {
  ...
  icons: {
    icon: '/favicon.svg?v=7.0.0',
    shortcut: '/favicon.ico?v=7.0.0',
    apple: '/apple-touch-icon.png?v=7.0.0',
  }
}
...
export default function RootLayout({
  ...
  return (
    <html lang="de">
      <head>
        <link rel="icon" href="/favicon.svg?v=7.0.0" type="image/svg+xml" />
        <link rel="icon" href="/icon-192.png?v=7.0.0" sizes="192x192" type="image/png" />
        <link rel="apple-touch-icon" href="/apple-touch-icon.png?v=7.0.0" />
