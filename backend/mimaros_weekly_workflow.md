...
Dieses Dokument beschreibt den vollautomatisierten Prozess zur Trend-Recherche, Asset-Erstellung und Veröffentlichung deiner YouTube Shorts / Reels im offiziellen **MIMAROS** Corporate Design.
...
Triggere jeden Montag den Endpunkt `/api/generate-weekly-schedule`. Gemini Pro scannt die B2B-Trends, strukturiert sie nach der **MIMAROS** Funnel-Logik und erstellt 7 neue Post-Entwürfe in der Datei `mimaros_publication_schedule.json`.
...
Öffne die Datei `mimaros_publication_schedule.json` im Workspace und prüfe die Entwürfe. Du hast zwei Möglichkeiten:
...
2. **Eigenes Video verlinken (Personal Brand):** Wenn du ein eigenes Video aufgenommen hast, trage den relativen oder absoluten Pfad zu deiner `.mp4`-Datei im Feld `"video_asset"` ein.

---

## 3. Vollautomatisch Veröffentlichen (Rendering & Upload)
Sobald du bereit bist, einen Post zu veröffentlichen, feure den Publish-Befehl ab. Das System übernimmt ab hier alles: Untertitel, Logo, CI-Rahmen, Beschreibungstext, Follow-CTA und den Upload zu YouTube Shorts.
...
* **Vollautomatische Schritte im Hintergrund:**
  1. **Prüfung:** Liegt am angegebenen Pfad ein fertiges Video vor?
...
---
*© MIMAROS — Automated Publishing Workflow*
